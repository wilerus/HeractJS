...
define(['form/App', './FormLayoutBuilder', 'form/views/FormLayoutView',
        'form/views/AccountView',
        'form/views/editors/AttachmentEditorView',
        'form/views/editors/TextEditorView',
        'form/views/editors/DateTimeEditorView',
        'form/views/editors/DateTimeMobielEditorView',
        'form/views/editors/NumberEditorView',
        'form/views/editors/DurationEditorView',
        'form/views/editors/TextareaEditorView',
        'form/views/editors/AccountEditorView',
        'form/views/editors/InstanceEditorView',
        'form/views/editors/MultiValueProxyEditorView',
        'form/views/widgets/CommentEditView',
        'form/views/widgets/TimespentSaveDialog',
        'form/views/editors/ListOfValuesEditorView',
        'form/views/editors/StaticContentEditorView',
        'form/views/editors/BooleanEditorView',
        'form/views/editors/RadioSelectorEditorView',
        'form/views/editors/MultiSelectEditorView'],
